...
SKILL_CONTRACTS = {
    item.name: item for item in [
        SkillContract("explain_record", "1.0.0", "health_doctor", "low",
                      ...
                      ("current_session", "recent_assessments", "visible_memory", "feedback_preferences"), False, False,
        ...
        SkillContract("comprehensive_review", "1.0.0", "health_doctor", "medium",
                      ("owner", "caregiver", "viewer"),
                      ("current_session", "trend", "recent_assessments", "visible_memory", "self_report_memory", "feedback_preferences"), False, False,
                      {"goal": "str", "member_id": "str", "decision": "str"},
                      {"reply": "str", "decision": "str"}),
        ...
        SkillContract("urgent_care", "1.0.0", "health_doctor", "high",
                      ("owner", "caregiver", "viewer"),
                      ("current_session", "recent_assessments", "visible_memory", "feedback_preferences"), True, False,
                      {"goal": "str", "member_id": "str", "decision": "str"},
                      {"reply": "str", "decision": "str"}),
